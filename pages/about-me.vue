...
<template>
    <section class="flex flex-col gap-7 text-white p-4">
        ...
        <section class="flex flex-col gap-9">
            ...
            <div>
                ...
                <div class="space-y-4">
                    <p>Ecoinsoft Solution Company ( April,2024 - Present) <br>
                        <span class="text-gray-400">Web FrontEnd Developer</span>
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex gap-2">
                    ...
                    <img src="../public/svgIcons/vue.svg" alt="">
                    <img src="../public/svgIcons/Nuxt.svg" alt="">
                    <img src="../public/svgIcons/css.svg" alt="">
                    <img src="../public/svgIcons/tailwind.svg" alt="">
                    <img src="../public/svgIcons/html.svg" alt="">
                    <img src="../public/svgIcons/scss.svg" alt="">
                    <img src="../public/svgIcons/git.svg" alt="">
                </div>
            </div>
        </section>
    </section>   
